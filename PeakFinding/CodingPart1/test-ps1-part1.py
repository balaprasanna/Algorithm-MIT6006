...
def isFast(filename):
    global array
    array = read_input(filename)
    cProfile.runctx('slow_find_1d_peak(array)',globals(),{'array':array}, '1d_slow_stats')
    cProfile.runctx('quick_find_1d_peak(array)',globals(),{'array':array},  '1d_quick_stats')
...
class TestPS1Part1(unittest.TestCase):
    ...
    def test6(self):
        ...
        fastEnough = isFast("4_big_random.txt")
        self.assertTrue(doesPass)
